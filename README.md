# MassagemHub Monitor — Pacote 3.1.1
...
## Pacote 3.1.1 — SEO inteligente e sentinela
...
## Configurando o Google Search Console — Pacote 3.1.1
...
Se `GOOGLE_SERVICE_ACCOUNT_JSON` não estiver configurado, o job é pulado com sucesso. Portanto você pode subir e testar o Pacote 3.1.1 antes de configurar a API.
...
2. **Perfil sentinela** — Pacote 3.1.1, opcional;
3. **Navegador E2E** — Pacote 2;
4. **Google Search Console** — Pacote 3.1.1, opcional.
...
Substitua os arquivos do repositório pelos do Pacote 3.1.1 e rode:
